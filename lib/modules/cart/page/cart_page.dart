        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ProductInfo productInfo = controller.cartItems[index];
              return ProductWidget(productInfo: productInfo, isCart: true);
            },
          ),
        ),
        Container(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () => Text(
                      controller.sumPrice.value.toStringAsFixed(2),
                      style: TextStyle(
                        color: Get.theme.colorScheme.surface,
                        fontSize: 18.sp,
                        fontWeight: FontWeight.w500,
        ...
        Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child:
                  Text("Go to shopping", style: TextStyle(color: Colors.white)),
            ),
          ],
        ),
      ],
